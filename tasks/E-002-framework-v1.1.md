...
- 2026-09-19T18:25:47+08:00：T-0032～T-0035 全部 done（Leader 審核）。Leader 追加：extract-cards.sh 輸出 epic 欄、gen-schedule.mjs 依 cfg.epic 過濾（驗證 E-001 仍 31 卡含 T-0000）；CLAUDE.md 寫入權責表 src/* 列改 worktree 措辭。角色檔改動於下個 session 生效。下一步 T-0036 匯出乾淨範本。
- 2026-09-19T18:38:52+08:00：T-0036 done（20214b5）。追認第 10 章保留 5 題問卷。E-002 全部完成；框架 v1.1 效果由下一個 Epic 驗證。建議：收工檢查加「重跑 export 後 git diff --exit-code framework-template」。
