...
|---|---|---|---|---|---|
| T-0044 | 第二個 uptime check＋告警政策；06 回填（r2） | dev-ops／sonnet | 2 | 2026-09-20 20:42 | r1 退回：文件宣稱與雲端內容不符；r2 修文字＋准改 06 §3.3 一行 |
...
| 項目 | 角色 | 備註 |
|---|---|---|
| 測試總結 r4（qa-lead）：立 D-018 pipeline 驗證失效、重驗清單（TC-090、D-017、TC-080 直接比對、TC-091）、R-6 認定 | qa-lead | T-0045 done 後派 |
| 06 §5.1 回滾流程規格文字：演練後必 --to-latest 還原 | plan-sd | 隨 P1 規格同步卡 |
