...
| 卡號／項目 | 阻塞原因 | 解除條件 |
|---|---|---|
| NFR-003 24 小時採樣 | Monitor Health 首次 run 三次取樣全失敗，疑 STAGING_BASE_URL 值含空白或結尾斜線 | 使用者修正變數值為剛好 https://todo-app-dpevsdhdva-de.a.run.app 並手動 Run workflow 一次，之後每 5 分鐘自動採樣 |
...
| — | Gate 2 報告 r2 | leader | T-0030 | 提交使用者最終裁決 |
