...
|---|---|---|---|---|---|
| T-0030 | 測試總結 r2（含 staging 證據）與 Gate 2 最終建議 | qa-lead / opus | 1 | 17:30 | NFR-003 未滿 24h 標採樣中 |
| （無） | | | | | |
...
| 卡號 | 標題 | 審核者 | 備註 |
|---|---|---|---|
| T-0028 | AT r3 staging（36 過／1 敗規格文字／3 間歇）| qa-lead（T-0030）| 分支待 dev-tl 合併 |
| T-0029 | UAT r2 staging（10/10）| qa-lead（T-0030）| |
